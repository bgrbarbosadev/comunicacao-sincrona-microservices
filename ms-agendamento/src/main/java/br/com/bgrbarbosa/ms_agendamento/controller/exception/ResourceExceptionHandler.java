package br.com.bgrbarbosa.ms_agendamento.controller.exception;



import br.com.bgrbarbosa.ms_agendamento.service.exception.DatabaseException;
...
/*
	...
	public ResponseEntity<StandardError> database(PSQLException e, HttpServletRequest request) {
		HttpStatus status = HttpStatus.BAD_REQUEST;
		StandardError err = new StandardError();
		err.setTimestamp(Instant.now());
		err.setStatus(status.value());
